<aside class="col-md-2 sidebar p-0">
    ...
    <a href="../manajemen_stok/manajemen_stok.php" class="d-flex gap-2" style="color: #F3C623"><i class="bi bi-archive"></i>Stok Barang</a>
    <a href="../laporan_pemasukan.php" class="d-flex gap-2"><i class="bi bi-clipboard2-data"></i>Laporan Keuangan</a>
